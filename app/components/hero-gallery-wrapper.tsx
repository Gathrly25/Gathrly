...
const HeroDemo1 = () => {
  return (
    <ContainerScroll className="h-[350vh]">
      ...
      <ContainerScale className="relative z-10 text-center mt-10">
        <h1 className="max-w-xl text-lg md:text-5xl font-bold tracking-tighter text-slate-800 ">
          Venues That Speak for Themselves
        </h1>
        <p className="my-4 max-w-xl text-sm text-slate-700 md:text-lg">
          Discover stunning spaces that set the tone for your event refined
          interiors, vibrant ambiance, and details made to impress
        </p>
      </ContainerScale>
    </ContainerScroll>
  );
