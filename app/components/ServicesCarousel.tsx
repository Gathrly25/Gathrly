    ...
    >
      ...
      <div className='px-10 lg:px-16 mb-8 relative z-10'>
        <div className='flex items-center gap-4 mb-3'>
          <Sparkles className='w-8 h-8 text-amber-400 drop-shadow-[0_0_10px_rgba(245,158,11,0.4)]' />
          ...
          <Star className='w-8 h-8 text-amber-400 drop-shadow-[0_0_10px_rgba(245,158,11,0.4)]' />
        </div>
