// app/lib/venues/venues.data.ts
export const venuesData: Record<string, any> = {
    "lofte-23": {
        name: "Lofte 23",
...
// Helper to get venues as array
export const getVenuesArray = () => {
  return Object.entries(venuesData).map(([slug, venue], index) => ({
    id: index + 1,
    slug,
    name: venue.name,
